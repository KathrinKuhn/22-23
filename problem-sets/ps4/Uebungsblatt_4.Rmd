...
```{r "1_a"}
eu_makro <- read_csv("C:/Users/kuhn-/OneDrive/Dokumente/GitHub/22-23/problem-sets/ps4/data/EU_Makro.csv")
...
```{r "1_f"}
g2 <- g1 + geom_abline(intercept= 6.895, slope=0.0382, colour="blue")
